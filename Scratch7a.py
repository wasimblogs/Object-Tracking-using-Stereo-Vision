...
def rectifyV(imageL, imageR, FIND_DEPTH_OBJECTS=False):
    """
    ...
    disparity is disparity of stereo pairs. Unnormalized disparity.
    ...
    if FIND_DEPTH_OBJECTS:
        ...
        return rectifiedL, rectifiedR, disparity, 0
        disparity = disparity / np.max(disparity)
